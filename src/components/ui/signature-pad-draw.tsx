...
export const SignaturePadDraw = ({
  ...
  value,
  onChange,
  recipientColor = '#000000', // Add recipient color prop with black fallback
  ...props
  ...
  // Use recipient color instead of selectable colors
  const [selectedColor, setSelectedColor] = useState(recipientColor)
  ...
  return (
    <div className={cn('w-full h-full', className)}>
      ...
      {isSignatureValid === false && (
        <div className='flex absolute bottom-4 left-4 gap-2'>
