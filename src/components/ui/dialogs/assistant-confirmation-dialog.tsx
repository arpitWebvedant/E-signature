  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <Form {...form}>
          <form>
            <fieldset disabled={isSubmitting} className="p-0 border-none">
              <DialogHeader>
                <DialogTitle>
              ...
              <DialogFooter className="mt-4">
                <Button type="button" className='flex-1 cursor-pointer bg-black/5 hover:bg-black/10'
        variant='outline' onClick={onClose} disabled={isSubmitting}>
                  <Trans>Cancel</Trans>
                </Button>
                <Button
                  type="button"
