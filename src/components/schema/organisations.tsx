// Replace @prisma/client enums with local ones
...
export enum OrganisationGroupType {
  ...
  EXTERNAL_ORGANISATION = 'EXTERNAL_ORGANISATION', // in case needed
}
...
export const isOrganisationUrlProtected = (url: string) => {
  return PROTECTED_ORGANISATION_URLS.some((protectedUrl) =>
