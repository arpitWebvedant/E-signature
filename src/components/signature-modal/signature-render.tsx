...
import { SIGNATURE_CANVAS_DPI, isBase64Image } from '@/components/lib/constants/signatures'
...
export const SignatureRender = ({ className, value }: SignatureRenderProps) => {
  ...
  return (
    <canvas
      ref={$el}
      className={cn('w-full h-full dark:hue-rotate-180 dark:invert', className)}
