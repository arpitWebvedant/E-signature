...
const config = {
  ...
  content: [
    './src/**/*.{js,ts,jsx,tsx}', // ✅ Includes all Next.js file types
    './pages/**/*.{js,ts,jsx,tsx}',
  ...
  theme: {
    extend: {
      ...
      borderColor: {
        DEFAULT: 'hsl(var(--border))', // ✅ Sets default border color
      },
      fontFamily: {
      ...
      colors: {
        ...
        input: 'hsl(var(--input))',
        signatureBorder: 'hsl(var(--signature-border))',
        ring: 'hsl(var(--ring))',
        background: 'hsl(var(--background))',
        foreground: 'hsl(var(--foreground))',
        colorTitle: 'hsl(var(--color-title))',
        colorBackground: 'hsl(var(--color-background))',
        colorCard: 'hsl(var(--color-card))',
        colorMute: 'hsl(var(--color-mute))',
        colorTextDefault: 'hsl(var(--color-text-default))',
